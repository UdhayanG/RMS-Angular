...
import { RoleComponent } from './role/role.component';
 ...
 @NgModule({
  declarations: [
    ...
    DashboardComponent, 
    HeaderComponent, UserHeaderComponent, PrivacypolicyComponent, LoginComponent, AboutComponent, ContactComponent, MailverificationComponent, OtpverifyComponent, RegsuccessComponent, RoleComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
